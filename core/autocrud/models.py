...
from core.autocrud.base_report import GetExcelReport
from core.autocrud.views_crud import *
from core.autocrud.views_crud_ajax import *


class BaseModel(models.Model):
    """Definición del modelo para BaseModel."""
