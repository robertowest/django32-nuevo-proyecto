...
class PersonaTable(tables.Table):
    ...
    actions = tables.TemplateColumn(template_code=ACTIONS, 
                                    verbose_name=_('Acciones'), orderable=False)
...
class PersonaTableModal(tables.Table):
    nombre_apellido = tables.LinkColumn('persona:read', args=[A('pk')], 
                                        verbose_name=_('Nombre'), orderable=False, 
