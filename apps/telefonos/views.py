...
from .tables import TelefonoTable
from .filters import TelefonoFilter, TelefonoFilterForm
from .forms import TelefonoForm


PERMISSION = '{label}.view_{model}'.format(label='telefonos', model='telefono')
...
class MyListView(PermissionRequiredMixin, SingleTableView):
    ...
    model = Telefono
    table_class = TelefonoTable              # SingleTableView
...
class MyFilterView(MyListView, FilteredTableView):
    ...
    filter_class = TelefonoFilter            # FilteredTableView (filterset_class)
    formhelper_class = TelefonoFilterForm    # FilteredTableView
    template_name = 'comunes/tabla.html'
